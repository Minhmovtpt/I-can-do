...
- **Responsibility:** manage daily tasks and habits creation/editing/deletion, and provide reset options for tasks, stats, and database.
- **Depends on:** dailyTaskService, habitService, and Firebase APIs.

### `src/modules/webShortcuts.js`

- **Responsibility:** render and handle quick access buttons to external websites.
- **Depends on:** webShortcutService for data retrieval.

### `src/modules/financeGuard.js`

- **Responsibility:** provide password protection for accessing the finance module.
- **Depends on:** DOM elements for modal and input handling.
